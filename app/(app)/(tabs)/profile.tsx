...
import { View, StyleSheet, ScrollView, Switch, TouchableOpacity, Pressable, TextInput, Alert } from 'react-native';
...
export default function ProfileScreen() {
  const { xp, streak, selectedLevel, badges, displayName, setDisplayName } = useUserStore();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileHeader}>
        ...
        <WKText style={styles.profileName}>{displayName}</WKText>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
        ...
        <WKCard style={styles.sectionCard}>
          <View style={styles.sectionHeader}>
            <WKText variant="heading2">👤 Hesap Ayarları</WKText>
            {!isLoggedIn && (
              <View style={styles.demoBadge}>
                <WKText variant="caption" color={Colors.text.secondary}>Demo Hesap</WKText>
              </View>
            )}
          </View>
          ...
          {isLoggedIn ? (
            <>
              <View style={styles.prefRow}>
                <View style={{ flex: 1 }}>
                  <WKText variant="bodySm">Kullanıcı Adı</WKText>
                  {editingName ? (
                    <TextInput
                      ...
                      accessibilityLabel="Kullanıcı adı gir"
                    />
                  ) : (
                    <WKText variant="caption" color={Colors.text.secondary}>{displayName}</WKText>
                  )}
                </View>
                <TouchableOpacity
                  ...
                  accessibilityLabel="Kullanıcı adını düzenle"
                >
                  <WKText style={styles.editBtnText}>✏️ Düzenle</WKText>
                </TouchableOpacity>
              </View>

              <View style={[styles.prefRow, { marginTop: Spacing.s12 }]}>
                <View style={{ flex: 1 }}>
                  <WKText variant="bodySm">E-posta</WKText>
            ...
            <>
              <WKText variant="caption" color={Colors.text.secondary} style={{ marginBottom: Spacing.s12 }}>
                Üye olarak ilerlemenizi kaydedin, cihazlar arası senkronize edin ve arkadaşlarınızla yarışın.
              </WKText>
              <Pressable
              ...
              >
                <WKText style={styles.joinBtnText}>Üye Ol / Giriş Yap →</WKText>
              </Pressable>
            </>
          )}
        </WKCard>
